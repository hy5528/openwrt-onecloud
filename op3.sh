...
## 提取 pdnsd-alt、upx
merge_package main https://github.com/kenzok8/jell.git package/kenzok8-package pdnsd-alt upx
## 提取 luci-base
merge_package openwrt-24.10 https://github.com/immortalwrt/luci.git feeds/luci/modules modules/luci-base
## 提取 luci-mod-network
#merge_package openwrt-24.10 https://github.com/immortalwrt/luci.git feeds/luci/modules modules/luci-mod-network
